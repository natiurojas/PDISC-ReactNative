...
const productos = [
    { nombre: 'Kirby Arride(2003)', descripcion: 'Un videojuego de aventuras para Nintendo Switch', precio: '$49.990', imagen: Producto1 },
    { nombre: 'Sonic 2', descripcion: 'Un videojuego de plataformas para Nintendo Switch', precio: '$69.990', imagen: Producto2 },
    { nombre: 'Resident Evil 3', descripcion: 'Un videojuego de survival horror para Nintendo Switch', precio: '$39.990', imagen: Producto3 },
]
